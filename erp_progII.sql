...
values("SideroA.E.", "A.Papadreou 30", 2105678934, "info@sidero.gr"),
      ...
      ("ChalkosE.P.E.", "Iera Odos 219", 2103434334, "info@chalkos.gr"),
      ("GoldSuppl", "Panepistimiou 27", 2105454554, "info@gold.gr"),
      ("SilverS", "Ermou 19", 2108989889, "info@silver.com"),
      ("Paper4All", "Thiseos 136", 2119090990, "customers@paper4all.com");
