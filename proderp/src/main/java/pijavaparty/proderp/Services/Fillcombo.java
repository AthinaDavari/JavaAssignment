...
public class Fillcombo {
     ...
     * @param prodraw-list of raw materials included in product's recipe temporarily saved in java until we save the process
     * @param prod-the product which we want to change the recipe (add ingredients) or the product we want to create
     * @return list of raw materials (string type objects with raw materials' names and ids) not included in product's recipe  
     */
