...
public class AddNewOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Add a New Order From a Supplier");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Delivered", "Pending" }));

        jTextField3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        saveadd.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        saveadd.setIcon(new javax.swing.ImageIcon("C:\\Users\\USER\\Desktop\\Pics\\save.png")); // NOI18N
    ...
    private void showSOrdersTable(){
        ...
        DefaultTableModel model=(DefaultTableModel) S_Orders_table.getModel();
    ...
    private void saveaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveaddActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Please enter all fields.");
            ...
            String supplierid = jTextField2.getText().trim();
